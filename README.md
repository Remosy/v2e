...
```
```
python v2e.py -i input/tennis.mp4 --overwrite --timestamp_resolution=.003 --auto_timestamp_resolution=False --dvs_exposure --avi_frame_rate=59.94 duration 0.005 --output_folder=output/rain --overwrite --pos_thres=.15 --neg_thres=.15 --sigma_thres=0.03 --dvs_aedat2 rain.aedat --output_width=640 --output_height=480 --stop_time=60 --cutoff_hz=15 
```
